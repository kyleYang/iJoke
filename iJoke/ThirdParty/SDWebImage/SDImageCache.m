...
- (id)initWithNamespace:(NSString *)ns
{
    if ((self = [super init]))
    {
        NSString *fullNamespace = [@"com.ThreeFolk.SDWebImageCache." stringByAppendingString:ns]; //should not change
        
        // Create IO serial queue
        _ioQueue = dispatch_queue_create("com.ThreeFolk.SDWebImageCache", DISPATCH_QUEUE_SERIAL);
...
- (void)clearDiskWithCompletionBlock:(void (^)())completionBlock
{
    dispatch_async(self.ioQueue, ^
                   {
