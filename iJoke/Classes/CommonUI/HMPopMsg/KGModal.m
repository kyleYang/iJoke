    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        if(animated){
            ...
            [UIView animateWithDuration:kTransformPart1AnimationDuration animations:^{
                ...
                [UIView animateWithDuration:kTransformPart2AnimationDuration delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                    self.alpha = 1;
...
- (void)hideAnimated:(BOOL)animated{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [UIView animateWithDuration:kTransformPart2AnimationDuration animations:^{
            ...
            [UIView animateWithDuration:kTransformPart1AnimationDuration delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                self.alpha = 0;
