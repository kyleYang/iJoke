...
- (void)setMoviePlayer:(NGMoviePlayer *)moviePlayer {
    if (moviePlayer != _moviePlayer) {
        ...
        self.tableViewOptionControl = moviePlayer.view.controlsView.tableViewOptionControl;
        self.videoTitle = moviePlayer.view.controlsView.videoTitle;
        self.zoomControl = moviePlayer.view.controlsView.zoomControl;
        
        self.videoType = moviePlayer.view.controlsView.videoType;
        self.videoTableView = moviePlayer.view.controlsView.videoTableView;
    }
}
