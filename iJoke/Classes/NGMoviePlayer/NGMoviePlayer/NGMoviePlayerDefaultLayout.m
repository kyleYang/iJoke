...
#define kSettingWidth (UI_USER_INTERFACE_IDIOM()  == UIUserInterfaceIdiomPhone ? 50.f : 80.f)
#define kSettingHeigh (UI_USER_INTERFACE_IDIOM()  == UIUserInterfaceIdiomPhone ? 50.f : 80.f)
...
- (void)layoutSubviewsForControlStyleInline {
    ...
    self.zoomControl.frame = CGRectMake(width-kControlWidth-5, 3.f, kControlWidth, controlsViewHeight);
...
- (void)layoutSubviewsForControlStyleFullscreen {
    ...
    CGRect rct = CGRectMake(CGRectGetMaxX(self.zoomControl.frame), CGRectGetMinY(self.zoomControl.frame), CGRectGetMinX(self.settingControl.frame)-CGRectGetMaxX(self.zoomControl.frame), CGRectGetHeight(self.topControlsContainerView.frame));
    ...
    if (self.moviePlayer.view.controlsView.videoTableView != nil && !self.moviePlayer.view.controlsView.videoTableView.hidden) {
        
    }else{
        self.settingControlsView.frame = CGRectMake(width-kSettingWidth, 120, kSettingWidth, kSettingHeigh);
    }
    
    rct = self.tableViewOptionControl.frame;
    rct.origin.y = 10;
    rct.origin.x = 10;
    self.tableViewOptionControl.frame = rct;
    
    rct.origin.y = CGRectGetMaxY(self.tableViewOptionControl.frame)+5;
