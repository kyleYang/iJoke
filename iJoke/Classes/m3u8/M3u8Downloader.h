...
@interface M3u8Downloader : NSObject<SegmentDownloadDelegate>
{
    ...
    float totalprogress;
    id<VideoDownloadDelegate> __weak_delegate delegate;
    BOOL bDownloading;
    BOOL downingState;
    NSString *youkuId;
    NSString *m3u8Url;
...
@property (nonatomic, weak_delegate)id<VideoDownloadDelegate> delegate;
...
@property (nonatomic, strong) SaveVideo *sVideo;
