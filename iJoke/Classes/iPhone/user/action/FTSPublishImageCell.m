...
#define kContentStatusPadd 15
#define kStatusHeight 17
...
@implementation FTSPublishImageCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.statusLabel = [[UILabel alloc] initWithFrame:CGRectMake(kContentOffX, 0, CGRectGetWidth(self.touchView.frame)-2*kContentOffX,kStatusHeight)];
...
- (void)configCellForImage:(Image *)image{
    ...
    self.statusLabel.text = [_image reviewStatus];
...
+(float)caculateHeighForImage:(Image *)image{
    ...
    height += kImageBUttonPaddY +kContentStatusPadd+kStatusHeight+ kImageOffX+kTouchButtomY;
